...
% 1 image presentation: 2 on 2 off x 30
% 2 image presentaiton: 2 on 8 delay 2 on 2 off x 15
...
% 4. Assertion checks that this code worked properly
%
% Notes: 
% there will be no worry of a repeat image, since images do not repeat
% across a task and there will only be 1 task per run. OK if last image of
% a run is the same as the first image in the next run. 
%
% Outputs
% <block_matrix>    7 x 2 matrix. First column indicates run #. Second 
